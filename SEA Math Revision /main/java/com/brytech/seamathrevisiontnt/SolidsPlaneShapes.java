...
public class SolidsPlaneShapes extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("Solids and Plane Shapes");
        ...
        pdfView.fromAsset("solids_and_plane_shapes.pdf").load();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent goback = new Intent(SolidsPlaneShapes.this.getActivity(), MainActivity.class);
